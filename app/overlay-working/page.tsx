  ...
  return (
    <div className="min-h-screen bg-[#0b1020] flex items-center justify-center">
      <div className="text-white text-center max-w-2xl mx-auto p-6">
        <h1 className="text-4xl font-bold mb-8">🎯 Working Overlay</h1>
...
export default function OverlayWorking({ searchParams }: { searchParams: { t?: string } }) {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#0b1020] flex items-center justify-center">
