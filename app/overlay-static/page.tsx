...
export default async function OverlayStaticPage({ searchParams }: { searchParams: { t?: string } }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '28px', marginBottom: '20px' }}>🎯 Static Overlay</h1>
