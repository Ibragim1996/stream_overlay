...
export default async function OverlayV2Page({ searchParams }: { searchParams: { t?: string } }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '28px', marginBottom: '20px' }}>🎯 AI Overlay V2</h1>
