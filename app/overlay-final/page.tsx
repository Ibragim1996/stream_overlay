...
export default async function OverlayFinalPage({ searchParams }: { searchParams: { t?: string } }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '28px', marginBottom: '20px' }}>🎯 Final Overlay</h1>
